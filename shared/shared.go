...
import (
	...
	"github.com/cyberbono3/monit_bot/shared/db"
...
func Worker(wg *sync.WaitGroup, addr string, r *NodesStatus) {
	...
	port := func(host string) int {
		if strings.Contains(host, ":"+strconv.Itoa(port1)) {
...
func Contains(params ...interface{}) bool {
	...
	if t != reflect.Slice && t != reflect.Array {
		log.Fatal("Type Error! Second argument must be an array or a slice.")
	}
